...
var box = {
    ...
    move: function(){
        ...
        if(box.goLeft && box.xPos > 0 && !gameOver){
            box.xPos = box.xPos - 4;    
        }
        if(box.goRight && box.xPos < mycanvas.width - 10 && !gameOver){
            box.xPos += 4;    
        }
...
//This function control the amount of circles that are falling on the screen
function myFunction(){
